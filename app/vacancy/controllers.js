...
const Specialization = require('../specializtions/models/Specialization')
...
const getVacancy = async (req, res) => {
    ...
    if(vacancy)
        ...
        res.status(404).send({message: 'Vacancy with that id is not faund'})
}
...
//     const vacancies = Vacancy.findAll({
//         where: options
//     })
//     res.status(200).send(vacancies)
// }
