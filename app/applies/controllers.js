...
const getEmpoyeeApplies = async (req, res) => {
    try{
...
const declineEmploee = async (req, res) => {
    try{
        await Apply.update(
            {
                status: DECLINED
        ...
        `Компания: ${company.name}, к сожелению ваша кондидатура не подходит на вакансию ${vacancy.name},`)
